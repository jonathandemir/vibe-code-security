...
const QA = [
    ...
    { q: "How does the GitHub App work?", a: "You simply install the Vouch GitHub App. It automatically securely analyzes your code context on every Push or Pull Request, processes it via our API, and posts plain-English fixes directly to the PR comment." },
